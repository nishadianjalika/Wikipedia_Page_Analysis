...
def subtopic_frequency_analysis(df):
    ...
    top_subtopics.to_csv('scratch/n11357738/subtopic_discussion_frequency_analysis.csv', index=False)
...
def main():
    ...
    #this should be done after creating the clean subtopics and content csv. So creating the plot again.
